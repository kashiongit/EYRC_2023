...
def write_csv(loc, lat_long):
    ...
    '''
    with open(lat_long.csv, 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(["lat", "lon"])
        writer.writerow(loc)

def tracker(ar_id, lat_long):
    ...
    '''
    coordinate = lat_long.get(ar_id, None)
    if coordinate:
